...
function App() {
    ...
    return (
        <Routes>
            <Route path='/' element={<RootLayout handleProductsData={handleProductsData} />}>
                <Route index element={<Home />} />
                <Route path='/about-us' element={<About />} />
                <Route path='/contact-us' element={<Contact />} />
                <Route path='/products' element={<Products handleProductsData={handleProductsData} />} />
                <Route path='/products-page' element={<ProductsPage data={productsPageData} />} />
