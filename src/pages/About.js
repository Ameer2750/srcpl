    ...
    <div className='bg-[#f8f8f8]  '>
      ...
      <div className='py-20'>
        ...
        <div className='flex lg:flex-row flex-col lg:justify-between items-center lg:px-14 px-10 lg:my-24 py-10 lg:mx-8 lg:gap-10 gap-5'>
          <div className='flex flex-col lg:w-[50%] lg:-mt-10 gap-4'>
        ...
        <div className='flex lg:flex-row flex-col lg:justify-between items-center gap-5  lg:px-14 lg:mx-8 lg:-mt-10 px-10 py-10'>
