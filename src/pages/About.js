      ...
      <div className='py-20'>
        ...
        <div className='flex flex-row justify-between items-center px-14 my-24 mx-8 gap-10'>
          <div className='flex flex-col w-[50%] -mt-10 gap-4'>
            <h1 className='text-3xl text-orange-500 font-bold'>About SRCPL</h1>
        ...
        <div className='py-24'>
          <div className='flex flex-col items-center gap-4 '>
            <h1 className='text-3xl text-orange-500 font-bold'>Team Overview</h1>
          ...
          <div className='py-10 my-14'>
            <h1 className='text-3xl text-orange-500 font-bold text-center '>S.R Group Overview</h1>
          </div>
          ...
          <div className='my-14'>
          <h1 className='text-3xl text-orange-500 font-bold'>Awards & Recognitions</h1>
      </div>
        </div>
      </div>
